...
import ReplenishmentPage from "./pages/ReplenishmentPage"; // Import the new replenishment page
...
const ProtectedRoutes = () => {
  ...
  // MainLayout already contains an <Outlet /> for rendering child routes
  return <MainLayout />;
};
